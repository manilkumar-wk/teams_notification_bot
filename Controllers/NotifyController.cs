...
namespace Microsoft.BotBuilderSamples.Controllers
{
    ...
    public class NotifyController : ControllerBase
    {
        ...
        public async Task<IActionResult> PostAsync([FromBody] NotificationPayload payload)
        {
            ...
            else
            {
                return NotFound(
                    new
                    {
                        message = "We couldn't find a user with the provided details. Please check and try again."
                    }
                );
            }
        }
        ...
        private async Task BotCallback(
        ...
        private async Task<string> GenerateConversationId(
        ...
        )
        {
            ...
            try
            {
                var conversationResource =
                    await connectorClient.Conversations.CreateConversationAsync(parameters);
